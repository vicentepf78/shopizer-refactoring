...
public class RestClientConfig {
	...
	public RestTemplate referenceRestTemplate(
		...
		return waveRestTemplate(builder, timeoutMs);
	}

	@Bean
	public RestTemplate contentRestTemplate(
			RestTemplateBuilder builder,
			@Value("${wave2.http.client.timeout-ms:5000}") long timeoutMs) {
		return waveRestTemplate(builder, timeoutMs);
	}

	private RestTemplate waveRestTemplate(RestTemplateBuilder builder, long timeoutMs) {
