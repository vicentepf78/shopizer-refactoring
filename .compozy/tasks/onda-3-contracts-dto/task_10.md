...
## Subtarefas
- [x] 10.1 Tabela outbox + repository (T44)
- [x] 10.2 Checkout em estágios + eventos outbox (T45–T46)
- [x] 10.3 Feature flag + dispatcher (T47)
- [x] 10.4 Gate reactor completo + atualização STATE (T48)
...
## Testes
- Testes unitários:
  - [x] Append outbox idempotente por aggregate+event type
- Testes de integração:
  - [x] Linhas outbox criadas quando flag habilitada
  - [x] Caminho legacy quando flag desabilitada
  - [x] Build reactor completo
